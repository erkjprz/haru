    ...
    <div className="text-center pt-2 pb-5">
      ...
      <div className="flex items-center justify-center gap-1.5">
        ...
        <input
          ...
          className="font-mono [font-variant-numeric:tabular-nums] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none text-4xl font-bold text-ink bg-transparent text-center w-full max-w-[220px] focus:outline-none placeholder:text-ink-soft/30"
        />
      </div>
